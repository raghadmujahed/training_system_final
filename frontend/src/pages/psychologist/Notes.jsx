  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="تدوين ملاحظاتك الإرشادية على الطلبة — سلوكية، نفسية، أو مهنية."
      />
      ...
      {loading ? (
        ...
        <EmptyState title="لا توجد ملاحظات" description="لم تُضف ملاحظات إرشادية بعد." />
      ) : (
        ...
        <div className="modal-overlay" onClick={closeModal}>
          <div className="modal-content max-w-[520px]" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h3>{editingId ? "تعديل ملاحظة" : "إضافة ملاحظة إرشادية"}</h3>
              ...
              <div className="modal-body">
                ...
                <div className="form-group">
                  ...
                  <textarea
                    ...
                    placeholder="اكتب ملاحظتك الإرشادية هنا..."
                    required
                  />
                </div>
              </div>
